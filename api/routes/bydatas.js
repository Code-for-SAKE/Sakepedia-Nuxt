...
// Create
router.post('/bydatas', config.isAuthenticated, breweryYearDatasController.create)

// Update
router.put('/bydatas/:id', config.isAuthenticated, breweryYearDatasController.update)

// Delete
router.delete('/bydatas/:id', config.isAuthenticated, breweryYearDatasController.delete)
